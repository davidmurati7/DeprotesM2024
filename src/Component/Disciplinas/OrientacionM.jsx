...
import logoN from '../Home/pentatlonm2.jpg'; 
...
class OrientacionM extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("OrientacionM").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de OrientacionM:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de OrientacionM:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("OrientacionM").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en OrientacionM:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de OrientacionM:", error.message);
    }
  }
