...
import logoN from '../Home/VoleibolM2.jpg'; 
...
class VoleibolM extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("VoleibolM").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de VoleibolM:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de VoleibolM:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("VoleibolM").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en VoleibolM:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de VoleibolM:", error.message);
    }
  }
