...
class Badminton extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("Badminton").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de Badminton:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de Badminton:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("Badminton").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en Badminton:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de Badminton:", error.message);
    }
  }
