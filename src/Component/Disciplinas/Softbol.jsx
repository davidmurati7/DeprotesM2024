...
class Softbol extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("Softbol").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de Softbol:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de Softbol:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("Softbol").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en Softbol:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de Softbol:", error.message);
    }
  }
