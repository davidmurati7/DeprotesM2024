...
import logoN from '../Home/TiroPistola2.jpg'; 
...
class TiroPistola extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("TiroPistola").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de TiroPistola:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de TiroPistola:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("TiroPistola").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en TiroPistola:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de TiroPistola:", error.message);
    }
  }
