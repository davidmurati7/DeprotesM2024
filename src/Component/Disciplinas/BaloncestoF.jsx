...
class BaloncestoF extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("BaloncestoF").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de BaloncestoF:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de BaloncestoF:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("BaloncestoF").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en BaloncestoF:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de BaloncestoF:", error.message);
    }
  }
