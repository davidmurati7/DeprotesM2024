...
const data = [
  ...
  { id: 2,  Dia: "lunes", Hora: "4 pm", CompetidorA: "A", CompetidorB: "B", Resultado: "", Ganador: "" },
  { id: 3,  Dia: "lunes", Hora: "4 pm", CompetidorA: "A", CompetidorB: "B", Resultado: "", Ganador: "" },
  { id: 4,  Dia: "lunes", Hora: "4 pm", CompetidorA: "A", CompetidorB: "B", Resultado: "", Ganador: "" },
  { id: 5,  Dia: "lunes", Hora: "4 pm", CompetidorA: "A", CompetidorB: "B", Resultado: "", Ganador: ""},
  { id: 6,  Dia: "lunes", Hora: "4 pm", CompetidorA: "A", CompetidorB: "B", Resultado: "", Ganador: "" },
];

const clave="12345"

class futbolC extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("FutbolC").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de FutbolC:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de FutbolC:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("FutbolC").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en FutbolC:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de FutbolC:", error.message);
    }
  }
