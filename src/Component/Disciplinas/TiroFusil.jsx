...
import logoN from '../Home/TiroFusil2.jpg'; 
...
class TiroFusil extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("TiroFusil").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de TiroFusil:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de Natacion:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("TiroFusil").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en TiroFusil:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de TiroFusil:", error.message);
    }
  }
