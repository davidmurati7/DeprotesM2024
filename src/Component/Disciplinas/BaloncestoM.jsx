...
import logoN from '../Home/Baloncestomasculino2.jpg'; 
...
class BaloncestoM extends React.Component {
  ...
  async getFutbolC() {
    try {
      const { data, error } = await supabase.from("BaloncestoM").select("*");
      if (error) throw error;
      this.setState({ data });
    } catch (error) {
      console.error("Error al obtener datos de BaloncestoM:", error.message);
    }
  }
  ...
  async updateFutbolC() {
    try {
      ...
      console.error("Error al actualizar datos de BaloncestoM:", error.message);
    }
  }
  ...
  async crearFutbolC() {
    try {
      ...
      const { data, error } = await supabase.from("BaloncestoM").insert([nuevoDato]);
      ...
      console.error("Error al crear datos en BaloncestoM:", error.message);
    }
  }
  ...
  async deleteFutbolC(dato) {
    try {
      ...
      console.error("Error al eliminar datos de BaloncestoM:", error.message);
    }
  }
